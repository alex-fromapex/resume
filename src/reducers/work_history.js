                    ...
                    positionsHeld: [{
                        ...
                        },
                        {
                            ...
                            bullets: [
                                ...
                                'Assisted with Illuminate product development using React+Redux, Bulma, ES6, Webpack, Git',
                                'Configured CloudFlare, HTTPS, MySQL, and various Apache settings to optimize server performance',
                                'Developed PHP/WordPress landing pages, CRM API integrations, Click Summit annual conference website WordPress template, and various ad hoc web applications to assist the marketing team with gathering new leads'
                            ]
                        }
                    ]
                },
